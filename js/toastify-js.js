...
(function (root, factory) {
    ...
    Toastify.lib = Toastify.prototype = {
        ...
        init: function (options) {
            ...
            this.options.time = options.time || new Date().toLocaleTimeString(); // Display message
        ...
        buildToast: function () {
            ...
            if (this.options.time) {
                divElement.innerHTML = '<span class="toastify-time">' + this.options.time + '</span><br/><p class="toastify-content">' + this.options.text + '</p>';
            } else {
                divElement.innerHTML = '<p class="toastify-content">' + this.options.text + '</p>';
            }
            ...
            if (typeof this.options.actions !== "undefined") {
                ...
                for (var key in this.options.actions) {
                    ...
                    actionElement.addEventListener("click", function (event) {
                            event.stopPropagation();
                            this.options.actions[event.target.getAttribute("data-name")].func(event);
                        }.bind(this)
                    );
